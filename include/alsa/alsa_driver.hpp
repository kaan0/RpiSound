...
public:
    ...
    // Audio operations
    Result<size_t> write(const HandlePtr& handle, const types::audio_span_t& audioData) override;
    Result<size_t> read(const HandlePtr& handle, types::audio_span_mut_t& audioBuffer, size_t framesToRead) override;
